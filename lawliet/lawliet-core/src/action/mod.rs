...
impl ActionInterface for Action {
    fn handle(
        ...
        match self {
            ...
            Action::SetNotebookFake(a) => a.handle(eng, ctx, actor, version, mutate),
            ...
            Action::TakeAbility(a) => a.handle(eng, ctx, actor, version, mutate),
            ...
            Action::TakePassive(a) => a.handle(eng, ctx, actor, version, mutate),
            ...
            Action::UpdatePressConference(a) => a.handle(eng, ctx, actor, version, mutate),
            ...
            Action::UpdateContactLogViewports(a) => a.handle(eng, ctx, actor, version, mutate),
            ...
            Action::PressConfAccess(a) => a.handle(eng, ctx, actor, version, mutate),
            Action::SetNewsAnchor(a) => a.handle(eng, ctx, actor, version, mutate),
        }
    }
}
